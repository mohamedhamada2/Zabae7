...
import com.alatheer.zabae7.home.product.SizeModel;
...
public class ProductSizeAdapter extends RecyclerView.Adapter<ProductSizeAdapter.ProductSizeHolder> {
    ...
    public ProductSizeAdapter(Context context, List<ProductSize> sizeModelList,ProductDetailsFragment productDetailsFragment) {
        ...
        holder.checkbox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (checkedPosition != holder.getAdapterPosition()) {
                    ...
                    productDetailsFragment.send_size(sizeModelList.get(position));
                }
            }
        });
    }
