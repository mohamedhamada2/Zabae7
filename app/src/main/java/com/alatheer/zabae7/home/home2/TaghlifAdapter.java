...
public class TaghlifAdapter extends RecyclerView.Adapter<TaghlifAdapter.TaghlifHolder> {
    ...
    public TaghlifAdapter(List<TaghlifOption> taghlifOptionList, Context context,ProductDetailsFragment productDetailsFragment) {
        ...
        holder.checkbox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (checkedPosition != holder.getAdapterPosition()) {
                    ...
                    productDetailsFragment.send_package(taghlifOptionList.get(position));
