...
import com.alatheer.zabae7.offers.ProductAdapter;
...
public class ProductAdapter  extends RecyclerView.Adapter<ProductAdapter.ProductsHolder> {
    ...
    User user;
    Integer count = 1;
    public ProductAdapter(Context context, List<AllProductsCity> allProductList, OffersFragment homeFragment) {
