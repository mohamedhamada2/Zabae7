...
public class CuttingOptionAdapter extends RecyclerView.Adapter<CuttingOptionAdapter.CuttingOptionHolder> {
    ...
    UpdateProductFragment productDetailsFragment;
    public CuttingOptionAdapter(List<CuttingOption> cuttingOptionList, Context context,UpdateProductFragment productDetailsFragment) {
